document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchData() {
        const res = await fetch('https://689b682058a27b18087b3817.mockapi.io/Mercado', {
            method: 'GET',
            headers: {
    ...
    async function addNewTask() {
        ...
        console.log(task);
        if (task.trim() === '') return;
        await fetch(`https://689b682058a27b18087b3817.mockapi.io/Mercado`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    async function deleteTask(id){
        await fetch(`https://689b682058a27b18087b3817.mockapi.io/Mercado/${id}`,{
            method: 'DELETE',
        }).then(res => {
            if (res.ok) {
                return res.json();
